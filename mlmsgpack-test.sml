structure PackTest = struct
  ...
  val tests = [
    ...
    ("30", fn () => doPack packReal (1.0 / 0.0) = [0xcb, 0x7f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]),
    ("31", fn () => doPack packReal (~1.0 / 0.0) = [0xcb, 0xff, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]),
...
(*    ("34", fn () => doPack packReal Real.maxFinite = [0xcb, 0x7f, 0xef, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]),
    ...
    ("36", fn () => doPack packReal minPos = [0xcb, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01]),
    ("37", fn () => doPack packReal (minPos * ~1.0) = [0xcb, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01]),
    ("38", fn () => doPack packReal minNormalPos = [0xcb, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]),
    ("39", fn () => doPack packReal (minNormalPos * ~1.0) = [0xcb, 0x80, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]),
(*
